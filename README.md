...
- **No patch/rank/queue dimension in the aggregates.** The four stat tables are global rolling numbers — there's no way yet to ask "what were the best builds on patch 14.5" specifically. Data resets per-patch soon to be implemented.
